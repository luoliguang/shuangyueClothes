...
// // 素材数据
// import { getImagesUrl } from '../sever/sever'
...
// const xfgImages = ref([]) // 小方格速干图片

// getImagesUrl(1491).then(res => {
//   xfgImages.value = res.map(item => item.url)
//   console.log(xfgImages.value);
//   materials.forEach((item,index) =>{
//     if (item.name.includes('130克小方格速干圆领短袖')){
//       item.id = index + 1
//       item.thumbnail = xfgImages.value[index]
//     }
//   })
// })
